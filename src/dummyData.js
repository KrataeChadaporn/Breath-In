...
export const blogData = [
  ...
  },
  {
    ...
    part1: "ด้วยสภาพแวดล้อมในปัจจุบันที่เราไม่สามารถหลีกเลี่ยงหรือหนีจากเรื่องตึงเครียดที่เกิดขึ้นได้ ไม่ว่าจะเป็นเรื่องของการงาน สภาพแวดล้อมรอบตัว เช่น รถติดที่ต้องพบเจอทุกเช้าเย็น หนี้สิน ข้าวของแพง หรืออีกร้อยแปดพันอย่างที่ส่งผลให้เกิดความเครียด หรือเรื่องแย่ๆให้อยู่ภายในจิตใจ แต่สมาธิเป็นวิธีหนึ่งที่เป็นทางออกหรือวิธีบำบัดได้ การฝึกจิตสร้างสมาธิจะช่วยนำไปสู่ความสงบ เมื่อเกิดความสงบในจิตใจ ความคิดดีๆ จิตดีๆ ก็จะทำให้เราเกิดความสุข สงบตามมาได้",
    part2: "หลักการเริ่มต้นทำสมาธิง่ายๆ ด้วยตัวเอง โดยในระยะแรกควรฝึกนั่งเพียง 10 – 15 นาที ก็เพียงพอ นั่งขัดตะหมาด พยายามตั้งหลังให้ตรงแต่อยู่ในท่วงท่าที่สบาย  จากนั้นค่อยๆปล่อยวางความคิดนึก ปล่อยวางเรื่องราวต่างๆให้หมดไปจากใจ ทำสติจับความรู้สึกอยู่ที่ร่างกาย ให้รู้สึกว่าตอนนี้ตัวเราว่าขณะนี้นั่งอยู่อย่างไร",
    part3: "กำหนดความรู้สึกอยู่ที่สองช่องจมูก หายใจเข้านึกว่า “พุท” หายใจ ออกนึกว่า “โธ” จนรู้อยู่แต่ “พุท-โธ” ทุกลมหายใจเข้า-ออก และร่างกายก็จะเข้าสู่คำว่า “กายสงบ ใจสงบ”"
  },
  {
    id: 3,
    category: "blog",
    ...
    cover: "../images/blog/4.jpg",
    time: "12 ตุลาคม 2024",
    part1: "หลายครั้งที่เราต้องเผชิญกับความรู้สึกผิดหวังเสียใจ โดยที่หลายคนยังไม่ทันตั้งตัวหรือเตรียมใจไว้สำหรับสิ่งที่จะเกิดขึ้น หรืออาจเกิดจากความคาดหวังมากจนเกินไปให้สิ่งนั้นเป็นไปตามที่เราคิด เมื่อไม่เป็นดั่งใจความทุกข์ใจก็เกิดขึ้นได้ ซึ่งหากมีมากเกินไปหรือจมอยู่กับความรู้สึกเหล่านั้นเป็นเวลานาน อาจเกิดผลเสียต่อจิตใจรวมไปถึงโรคซึมเศร้า ขาดความมั่นใจในตัวเอง ขาดความมั่นคงทางจิตใจที่จะรับมือกับสิ่งต่าง ๆ รวมทั้งความไม่แน่นอนที่จะเกิดขึ้นได้",
    part2: "หลายครั้งที่ความจริงทำให้เราเจ็บปวด แต่การยอมรับความจริงคือหนทางที่จะนำเราไปสู่ความเปลี่ยนแปลง เป็นขั้นตอนแรกในการแก้ไขปัญหาและการพัฒนาตัวเองค่ะ เช่นวันนี้เราทำงานผิดพลาด เรามีเรื่องไม่เข้าใจกับคนที่เรารัก ผิดหวังจากปัญหาทางสังคม นี่คือโอกาสที่เราจะได้เรียนรู้และแก้ไขให้มันดีขึ้น เริ่มจากตัวเราเองค่ะ อย่างไรก็ตามเราไม่สามารถเปลี่ยนแปลงคนอื่นได้ แต่เริ่มได้ที่ตัวเราเองและเผื่อแผ่สิ่งดี ๆ ให้คนรอบข้างได้ค่ะ",
    part3: "เมื่อเรารู้ต้นเหตุของความคิด ความรู้สึก ปัญหาที่เรามีแล้ว จากการที่เราได้เรียกสติกลับมา จนเราพร้อมที่จะแก้ไขกับสิ่งที่เกิดขึ้น เมื่อนั้นคุณผู้อ่านจะพบกับความจริงของชีวิตว่าทุกสิ่งเกิดขึ้น ตั้งอยู่ และดับไปในที่สุด”"
  },
  {
    id: 4,
    category: "blog",
